...
<div class="container">
	...
	<h1><?=$h1?></h1>
		<div class="content">
			...
			<p>PaaS provides for web developing almost for key services, such as Java development or application hosting. Thunderrise use this platform for develop its web projects. The main PaaS advantage - its provider supports all the underlying computing and software, moreover users only need to log in and start using the platform – usually through a Web browser interface. It really makes devepment easier. The enterprise PaaS can be delivered through a hybrid model that uses both public IaaS and on-premise infrastructure or as a pure private PaaS that only uses the latter</p>
			<p>PaaS is one of three main categories of cloud computing services. The other two are software as a service (SaaS) and infrastructure as a service (IaaS). There are zillion of PaaS providers - the most popular is Heroku. There is an interesting fact - Heroku entirely works above AWS and connected with it. PaaS let Thunderrise to lessen time for start up our projects. Our Process of development standed more automatically! PaaS exacts no price with for high-technologies knowledge, so Thunderrise chose the best way to making our work process on the clouding computing</p>
			<p>Let's do great project together. Contact us and we will follow your dream! Thunderrise - We design and develop native apps!</p>
		</div>
