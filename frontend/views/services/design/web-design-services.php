...
$this->registerMetaTag(['name' => 'description', 'content' => 'As you know, the first thing a user see when he clicks on the site is it’s design. It is a foundation of every website, so there’s no need to say that it’s extremely important to stand out of the crowd. Thunderrise provides native web design services.']);
?>
...
<div class="container">
	...
	<h1><?=$h1?></h1>
		<div class="content">
            ...
            <p>As you know, the first thing a user see when he clicks on the site is it’s design. It is a foundation of every website, so there’s no need to say that it’s extremely important to stand out of the crowd. Thunderrise provides native web design services. We will follow your business goals so contact us and get your own design.</p>
			...
			<p>At Thunderrise we provide excellent web designing service. Our team of professional designers can create your site from nothing or redesign an existing site according to client's preferences. We provide a huge spectre of work in web designing. Custom designs are very important for business so be sure that our team will make it not only affordable and stylish but also unique.</p>
			...
			<p>Thunderrise use different <strong>Web Design Services</strong> in all projects. This way really makes process of development and involvement easier.</p>
			<p>Don't hesitate and contact this instant! Let us to bring to life your idea! Thunderrise - follow your dream!</p>
		</div>
