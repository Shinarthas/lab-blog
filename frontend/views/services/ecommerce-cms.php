...
<div class="container">
    <div class="row">
          <div class="content">
            ...
            <p>In lab3m a <strong>content management system (CMS)</strong> is a software application or set of related programs that are used to create and manage digital content. There are a lot of features of CMSes, such as:</p>
            <ul>
