...
<div class="container">
	...
	<h1><?=$h1?></h1>
		<div class="content">
            ...
            <p>WordPress is one of the most popular CMS for website creation. It’s the best solution for publication with all the support standards, usability and visual attraction. WordPress is also free to distribute. Thunderrise has a team of experienced WordPress developers so you can trust us a website creation.</p>
            <?= $this->render('//layouts/_estimate') ?>
            <p>With our assistance you can create or customize your website and make it the most profitable for your business needs. We spoke about the complication of updating your site so now it doesn’t matter. Keeping your site up-to-date won’t cost you any efforts because content management doesn’t require any special experience. WordPress is supported by all the devices and it can be upgraded with additional functionality via integrating third-party plugins. Contact Thunderrise and we will assist you in your own website creation.</p>
