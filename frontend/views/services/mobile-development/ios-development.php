...
$this->registerMetaTag(['name' => 'description', 'content' => 'Thunderrise provides the full pack of IOS Development services. It includes building, designing, testing and launching complete IOS applications. IOS apps increase yield of any company because it makes your project more accessible and bright.']);
?>
...
<div class="container">
	...
	<h1><?=$h1?></h1>
		<div class="content">
			...
			<p>Thunderrise provides the full pack of IOS Development services. It includes building, designing, testing and launching complete IOS applications. IOS apps increase yield of any company because it makes your project more accessible and bright.</p>
