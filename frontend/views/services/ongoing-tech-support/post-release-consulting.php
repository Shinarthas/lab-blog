...
$this->registerMetaTag(['name' => 'description', 'content' => 'In Thunderrise we provide a huge spectre of post-release support and maintenance services. We always seek for new effective solutions for proper product working so with the release our work is not yet finished.']);
?>
...
<div class="container">
	...
	<h1><?=$h1?></h1>
      ...
      <p>In Thunderrise we provide a spectre of <strong>post-release support</strong> and maintenance services such as:</p>
      <ul>
      ...
      <p>In many situations a software upgrade is inevitable part of development process. Utilizing new software features in application requires general upgrading of software. Also upgrades are needed to maintain innovativeness of specific system components. Thunderrise developers always seek for new effective solutions for proper product working and use best practices for your software upgrades.</p>
