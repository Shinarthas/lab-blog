...
<div class="container">
	...
	<h1><?=$h1?></h1>
		<div class="content">
			...
			<p>An enterprise is a term for a very large business network. Therefore the phrase "enterprise solutions" refers to business solutions for large corporations which have large networks. Thunderrise uses it in different fields of development. We realize custom development of enterprise solutions that help our clients automate and optimize their business processes.</p>
			...
			<p>Thunderrise - follow your dream and let's bring it to life!</p>
		</div>
