...
$this->registerMetaTag(['name' => 'description', 'content' => 'So how we do it in Thunderrise? Our opus primum is to provide excellent web development service. We earn our reputation by making our sites useful, profitable and UNIQUE.']);
?>
...
<div class="container">
	...
	<h1><?=$h1?></h1>
		<div class="content">
			...
			<p>Nowadays, if you want to rich high goal, you should have unique UI/UX design, powerful back-end, perfect SEO optimization and others factors. Thunderrise can give all of this opportunities.</p>
