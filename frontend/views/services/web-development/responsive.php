...
<div class="container">
	...
	<h1><?=$h1?></h1>
		<div class="content">
			...
			<p>Thunderrise has great team of web developers that will make this design for you. If you want to increase your income, you’ve got on the right page! Our web developers team includes: designers, front-end developers, back-end developers and Q&A. Are you still in doubt? OK, and if we told you that 95% of our project after making adaptive design increases income twice as much? Are you surprised? If you have your own idea of your website, please contact our consultants for further details so we could cooperate and create great thing together! If you don't have any idea, our designer will invent it for you! Thunderrise front-end developers direct you the best animation and optimization code of your future project. Back-end developers in Thunderrise invent the most convenient way to interact UX design with server and clients personal database. Finally, Q&A will test all process and give you only verified product. As simple as that you will get a fine product and enjoy our partnership.</p>
			<p>Thunderrise - follow your dream!</p>
		</div>
