...
.first-screen{background:#0D0D0D;position:relative;height:730px;}
    ...
    <div class="header__content" style="background: #000">
        ...
        <a itemprop="url" href="/services" class="header__menu-link"><span itemprop="name">Services</span></a>
            ...
            <div class="dropdown-menu dropdown-menu-right" style="background: black;">
                <button class="dropdown-item active" type="button" style="color: white;">English</button>
                <button class="dropdown-item" type="button" style="color: white;">简体中文</button>
                <button class="dropdown-item" type="button" style="color: white;">Русский</button>
            </div>
            <style>
            ...
            <div class="first-screen1">
                ...
                <div class="first-screen__fixed">
                    ...
                    <div style="background-color:#6927FF; width:30%; height: 1px; margin-bottom: 15px"></div>
                        <h1 class="first-screen__title" style="font-family: Druk Wide Bold;letter-spacing: 0.1em;"></h1><p class="multipleStrings first-screen__title" style="letter-spacing: 0.1em;"></p>
                ...
                strings: ["Efficacy,", "Transparency,", "Secure"],
                speed: 50,
        ...
        <div class="row" style="justify-content: center;">
            <div class="second-screen__content">
                ...
                <div class="second-screen__deploy">
                    <p class="second-screen__desc" style="color: #fff">
	...
	<div class="clip">
	    <div class="container">
	        <div class="row">
	        	<div class="fix-case">
                <div class="row">
        <div class="col-12 text-center" style="padding-top:150px"><h2 style="color: #fff; font-size: 48px;font-weight: 700;" class="mb-4">Trade3M</h2></div>
        ...
        <h2 style="color: #fff; font-size: 24px; color: #FFFFFF; line-height: 29px;" class="mb-4">Unlimited Trading and Custody Features</h2>
        <p style="font-style: normal;
font-weight: normal;
font-size: 18px;
line-height: 150%;
letter-spacing: 0.1em;
color: #FFFFFF;">Flexible platform, with hot and cold storage, enabling digital asset trading and management in one place.</p>
        <div style="font-style: normal; margin-top: 10px;
font-weight: normal;
font-size: 16px;
line-height: 17px;
color: #FFFFFF;
...
color: #FFFFFF;
text-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);"><img style="margin-right:10px;    float: left;
    margin-bottom: 15px;" src="/images/v.png" alt="check mark" >Portfolio managment features</div>
        </div>
...
<section id="section-services" class="ftco-section services-section" style="background-color: #151515; padding-top:0!important">
        <div class="container">
            <div class="row justify-content-center mb-5 pb-3" style="padding-top:150px">
                <div class="col-md-7 text-center heading-section ftco-animate">
                    <h2 style="color: #fff" class="mb-4">Services</h2>
                    <p style="color: #fff">Making blockchain part of your business</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-flex align-items-center">
                        ...
                        <div class="media-body pl-4 pl-md-0 pr-md-4 text-md-right">
                            <h3 class="heading">Finance & Payment Solutions
                            </h3>
                            <p class="mb-0 dis-none-t">When we develop Blockchain applications, We integrate the decentralization element of Blockchain in your payment app to maintain an immutable record and eliminate the instances of fraud.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-flex align-items-center">
                        ...
                        <div class="media-body pl-4">
                            <h3 class="heading">MVP (Minimal Viable Product) Creation</h3>
                            <p class="mb-0 dis-none-t">Our Blockchain Solutions revolve around Testing the waters before the launch of a full-fledged dApp with the development and launch of a dApp MVP.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-flex align-items-center">
                        ...
                        <div class="media-body pl-4 pl-md-0 pr-md-4 text-md-right">
                            <h3 class="heading">Crypto Exchange Development
                            </h3>
                            <p class="dis-none-t">We creating a hack-proof platform for the real-time exchange of cryptocurrencies or DEX.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-flex align-items-center">
                        ...
                        <div class="media-body pl-4">
                            <h3 class="heading">Smart Contracts Development & Audit
                            </h3>
                            <p class="dis-none-t">From Finance to fintech and Media to Public Sector, our Smart Contracts make business ecosystem conflict-free.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-flex align-items-center">
                        ...
                        <div class="media-body pl-4 pl-md-0 pr-md-4 text-md-right">
                            <h3 class="heading">Custom Blockchain Solutions
                            </h3>
                            <p class="dis-none-t">We offer customized Blockchain solutions to integrate with your existing mobile apps, making them dApps.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-flex align-items-center">
                        ...
                        <div class="media-body pl-4">
                            <h3 class="heading">Crypto Wallet Development
                            </h3>
                            <p class="dis-none-t">As part of our Blockchain Development Services, we create Crypto wallet dApps that hold hundreds of cryptocurrencies, while carrying information related to your wallet balance and purchase history.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-flex align-items-center">
                        ...
                        <div class="media-body pl-4 pl-md-0 pr-md-4 text-md-right">
                            <h3 class="heading">IEO (initial exchange offering) Services
                            </h3>
                            <p class="dis-none-t">Our all-round IEO services include preparing your idea for Investors, generation of cryptocurrency for distribution, development of white paper, and lastly Promotion of your IEO.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-flex align-items-center">
                        ...
                        <div class="media-body pl-4">
                            ...
                            <p class="dis-none-t">We offer customized Blockchain solutions to integrate with your existing mobile apps, making them dApps.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section style="background: #151515;padding-bottom: 150px;">
<div class="container">
    <div class="row">
        <div class="col-12 text-center"><h2 style="color: #fff; font-size: 48px;font-weight: 700;" class="mb-4">Trade3M</h2></div>
        <div class="col-12 col-lg-3" style="margin-top: 20px;">
        <!--<div><img style="margin-bottom: 60px" class="img-fluid" src="/images/l3m.png" alt=""></div>-->
        <h2 style="color: #fff; font-size: 24px; color: #FFFFFF; line-height: 29px;" class="mb-4">Unlimited Trading and Custody Features</h2>
        <p style="font-style: normal;
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center" style="padding:50px 15px 160px 15px">
                    ...
                    <input placeholder="Enter your email" style="margin: 50px 0;max-width: 525px; width:100%; padding: 18px 24px;font-style: normal;font-weight: normal;font-size: 16px;line-height: 140%;color: #313131;height: 100%;" type="text">
